    ...
    <table>
        ...
        <tbody>
            ...
            @foreach ($orders as $key => $order)
                ...
                @endif
                {{ $GLOBALS['total_formula2']=$GLOBALS['total_formula2']+$GLOBALS['total_formula']; }}
                <tr><td></td></tr>
            @endforeach
        </tbody>
        <tfoot>
                    ...
                    $orders->map(function($order) {
                        return array_reduce(
                            ...
                            function ($sum, $patient) {
                                ...
                                $general_invoice = $patient['order']['discount_percent'] > 0 ? round($total_invoice-($GLOBALS['total_formula2']*($patient['order']['discount_percent']/100)),2) : $GLOBALS['total_formula2'];
